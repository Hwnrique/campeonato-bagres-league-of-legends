const About = () => {
  return (
    <>
      <main className="w-full sm:w-5/6 lg:w-2/3 mx-auto p-6 sm:p-8 lg:p-10 mt-10 text-center">
        <h1 className="text-cyan-600 font-bold text-4xl md:text-5xl">
          Quem somos?
        </h1>
        ...
        <p className="text-white text-lg md:text-xl p-3 sm:p-4">
          ...
          se enfrentam e acumulam pontos...
        </p>

        <ul>
          <li className="text-white text-lg md:text-xl p-3 sm:p-4">
            A fase de pontos é realizada em MD1.
          </li>
          <li className="text-white text-lg md:text-xl p-3 sm:p-4">
            A disputa pelo terceiro lugar ocorre em MD3 – Fearless Draft.
          </li>
          <li className="text-white text-lg md:text-xl p-3 sm:p-4">
            A grande final é jogada em MD5 – Fearless Draft.
          </li>
        </ul>
        ...
        <p className="text-white text-lg md:text-xl p-3 sm:p-4">
          ...
          amistoso entre todos os membros...
        </p>
